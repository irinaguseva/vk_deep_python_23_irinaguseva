...
class TestGeneratorReadFilter(unittest.TestCase):
    ...
    def test_some_filters_in_one_string(self):
        words_in_one_line = ["roe",
                             "wild"]
        expected_result = ["A-chasing the wild deer and following the roe"]
        result = list(generator(self.test_file, words_in_one_line))
        self.assertEqual(result, expected_result)

    def test_filter_equals_line(self):
        word_single_line = ["Farewell"]
        expected_result = ["Farewell"]
        result = list(generator(self.test_file, word_single_line))
        self.assertEqual(result, expected_result)
